...
If you want to get liquid/solid phase predictions as well, add --liquid/--solid in the end. e.g 'python TCIT.py -t smiles -i input_list/test_inp.txt' --liquid --solid
